...
class DetectAPI:
    def __init__(self, weights='weights/yolov5s.pt', source='data/images', data='data/coco128.yaml', imgsz=None, conf_thres=0.25,
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'models/trained.pt', help='model path or triton URL')
